...
export declare class Optimade {
    ...
    getStructures(providerId: string, filter: string, page: number, limit: number): Promise<Types.StructuresResponse[] | null>;
    getStructuresAll(providerIds: string[], filter: string, page: number, limit: number, batch?: boolean): Promise<Promise<Types.StructuresResponse>[]> | Promise<Types.StructuresResponse>[];
    private followLinks;
    private wrapUrl;
